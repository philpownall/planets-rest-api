...
Simplified reduction process for VSOP87.  Requires vsop87a_small.js.
...
var vsop87a_small = require('./vsop87a_small.js');
var vsop87a_small_velocities = require('./vsop87a_small_velocities.js');

module.exports = class CPReduce {
    ...
    */
	...
	static reduce(body, jd_utc, observer) {
		...
		const earth = this.getBodyPV(3, jd_tdb);
    ...
    */
	...
	static getBodyPV(body, jd_tdb) {
		...
		switch (body) {
			case 1:
				b = vsop87a_small.getMercury(t);
				//v=vsop87a_full_velocities.getMercury(t);
				break;
			case 2:
				b = vsop87a_small.getVenus(t);
				//v=vsop87a_full_velocities.getVenus(t);
				break;
			case 3: //Earth
				b = vsop87a_small.getEarth(t);
				v = vsop87a_small_velocities.getEarth(t);
				break;
			case 4:
				b = vsop87a_small.getMars(t);
				//v=vsop87a_full_velocities.getMars(t);
				break;
			case 5:
				b = vsop87a_small.getJupiter(t);
				//v=vsop87a_full_velocities.getJupiter(t);
				break;
			case 6:
				b = vsop87a_small.getSaturn(t);
				//v=vsop87a_full_velocities.getSaturn(t);
				break;
			case 7:
				b = vsop87a_small.getUranus(t);
				//v=vsop87a_full_velocities.getUranus(t);
				break;
			case 8:
				b = vsop87a_small.getNeptune(t);
				//v=vsop87a_full_velocities.getNeptune(t);
				break;
			case 9:
				//b=vsop87a_small.getPluto();
				b = [0, 0, 0];
				break;
			case 10: //Moon
				const e = vsop87a_small.getEarth(t);
				const emb = vsop87a_small.getEmb(t);
				b = vsop87a_small.getMoon(e, emb);
